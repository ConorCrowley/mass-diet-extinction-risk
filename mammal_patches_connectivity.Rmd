...
saveRDS(all_patch_lookup, file = file.path("Spatial", "all_mammal_patch_lookup.rds"))
saveRDS(all_connectivity, file = file.path("Spatial", "all_mammal_connectivity.rds"))
```